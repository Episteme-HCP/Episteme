...
mvn.cmd clean test "-Dtest=HighPrecisionComplianceTest" "-DskipTests=false" "-Dsurefire.failIfNoSpecifiedTests=false" "-Dorg.episteme.project.name=Episteme" "-Dorg.episteme.report.path=../docs/HIGH_PRECISION_COMPLIANCE_REPORT.md" "-pl" "episteme-benchmarks" "-am" "-Denforcer.skip=true"
