...
cd "$PROJECT_ROOT"
APP_CLASS=org.episteme.apps.apps.shared.ScienceBrowser
LIB_DIR=episteme-featured-apps/launchers/libs/libs
MODULES_DIR=episteme-featured-apps/launchers/libs
