...
mvn.cmd clean test "-Dtest=HighPrecisionComplianceTest,NumericalCorrectnessTest" "-DskipTests=false" "-DfailIfNoTests=false" "-Dsurefire.failIfNoSpecifiedTests=false" "-pl" "episteme-benchmarks" "-am" "-Denforcer.skip=true"
