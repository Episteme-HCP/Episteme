...
public class ComputeContext {
     ...
     * @throws org.episteme.core.technical.algorithm.OperationCancelledException if cancelled
     */
    public void checkCancelled() {
        if (cancelled) {
            throw new org.episteme.core.technical.algorithm.OperationCancelledException();
        }
    }
    ...
    public TensorBackend getTensorBackend() {
        return new org.episteme.core.mathematics.linearalgebra.tensors.backends.CPUDenseTensorBackend();
    }
