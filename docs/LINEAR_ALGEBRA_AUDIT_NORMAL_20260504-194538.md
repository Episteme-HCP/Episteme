...
| Episteme (CARMA) | CPU (CARMA) | ⚠️ Partial | 23/40 | 39/40 |
...
| Episteme CPU (Sparse) | Generic JVM | ⚠️ Partial | 39/43 | 37/43 |
...
| Native CPU-BLAS (Real) | CPU (Native/Panama) | ⚠️ Partial | 35/40 | N/A |
| Native CUDA Sparse Linear Algebra Backend | N/A | 🔘 Disabled | N/A | N/A |
| Native FFM-BLAS (Complex) | CPU (FFM-BLAS) | ⚠️ Partial | N/A | 36/40 |
| Native FFM-BLAS (Real) | CPU (FFM-BLAS) | ⚠️ Partial | 8/40 | N/A |
| Native MPFR Dense Linear Algebra Backend | CPU (Panama/MPFR) | ⚠️ Partial | 33/40 | 22/40 |
| Native MPFR Sparse Linear Algebra Backend | Generic JVM | ⚠️ Partial | 27/43 | 28/43 |
...
| Native SIMD (Real) | Generic JVM | ⚠️ Partial | 34/40 | N/A |
...
| Native FFM-BLAS (Real) | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A |
...
| Native FFM-BLAS (Real) | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A |
| Native MPFR Dense Linear Algebra Backend | ✅ PASS | ✅ PASS | ✅ PASS | ✅ PASS | ❌ AssertionError | ➕ N/A | ✅ PASS | ❌ ClassCastException | ✅ PASS | ✅ PASS | ✅ PASS | ➕ N/A |
| Native MPFR Sparse Linear Algebra Backend | ✅ PASS | ✅ PASS | ✅ PASS | ✅ PASS | ✅ PASS | ✅ PASS | ✅ PASS | ❌ ClassCastException | ✅ PASS | ✅ PASS | ❌ AssertionError | ✅ PASS |
...
| Native SIMD (Real) | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A |
...
---
*Generated by Universal Audit Engine on Mon May 04 19:48:52 CEST 2026*
