...
| Episteme Distributed Linear Algebra Provider (LocalDistributedContext) | Generic JVM | ⚠️ Partial | 37/43 | 38/43 |
...
| Episteme gRPC Remote (localhost:50051) | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError |
...
| Episteme gRPC Remote (localhost:50051) | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ➕ N/A | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ➕ N/A |
...
| Episteme gRPC Remote (localhost:50051) | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError |
...
| Episteme gRPC Remote (localhost:50051) | ➕ N/A | ➕ N/A | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ➕ N/A | ➕ N/A | ➕ N/A | ➕ N/A | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ➕ N/A | ➕ N/A |
...
| Episteme Distributed Linear Algebra Provider (LocalDistributedContext) | ✅ PASS | ✅ PASS | ❌ AssertionError | ✅ PASS | ✅ PASS | ✅ PASS |
| Episteme gRPC Remote (localhost:50051) | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError | ❌ NoClassDefFoundError |
...
| Episteme gRPC Remote (localhost:50051) | ➕ N/A | ❌ NoClassDefFoundError | ➕ N/A | ❌ NoClassDefFoundError |
...
---
*Generated by Universal Audit Engine on Fri May 08 23:02:39 CEST 2026*
