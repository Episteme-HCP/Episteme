...
| :--- | :--- | :--- | :---: | :---: |
| Native MPFR Dense Linear Algebra Backend | CPU (Panama/MPFR) | ⚠️ Partial | 7/40 | 25/40 |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Native MPFR Dense Linear Algebra Backend | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Native MPFR Dense Linear Algebra Backend | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ✅ PASS | ✅ PASS | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ❌ AssertionError |
| Native MPFR Sparse Linear Algebra Backend | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ➕ N/A | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ✅ PASS | ✅ PASS | ❌ AssertionError | ➕ N/A | ❌ AssertionError | ❌ AssertionError | ✅ PASS | ❌ AssertionError | ❌ AssertionError |
...
---
*Generated by Universal Audit Engine on Tue May 12 18:06:13 CEST 2026*
