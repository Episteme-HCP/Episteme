...
call mvn test -pl episteme-benchmarks -am "-Drevision=1.0.0-beta2" -Dtest=org.episteme.benchmarks.test.audit.LinearAlgebraComplianceTest -Dorg.episteme.test.precision=fast -Dsurefire.failIfNoSpecifiedTests=false

echo [2/3] Auditing NORMAL Mode (Double 64-bit)...
call mvn test -pl episteme-benchmarks -am "-Drevision=1.0.0-beta2" -Dtest=org.episteme.benchmarks.test.audit.LinearAlgebraComplianceTest -Dorg.episteme.test.precision=normal -Dsurefire.failIfNoSpecifiedTests=false

echo [3/3] Auditing EXACT Mode (Arbitrary Precision)...
call mvn test -pl episteme-benchmarks -am "-Drevision=1.0.0-beta2" -Dtest=org.episteme.benchmarks.test.audit.LinearAlgebraComplianceTest -Dorg.episteme.test.precision=exact -Dsurefire.failIfNoSpecifiedTests=false
