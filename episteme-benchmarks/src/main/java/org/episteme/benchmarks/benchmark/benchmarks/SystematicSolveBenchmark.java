...
public class SystematicSolveBenchmark implements SystematicBenchmark<LinearAlgebraProvider<Real>> {
    ...
    @Override 
    public Class<LinearAlgebraProvider<Real>> getProviderClass() { 
        @SuppressWarnings({ "unchecked", "rawtypes" })
        Class<LinearAlgebraProvider<Real>> clazz = (Class) LinearAlgebraProvider.class; 
        return clazz;
    }
