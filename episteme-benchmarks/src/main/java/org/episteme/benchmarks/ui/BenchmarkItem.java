...
public class BenchmarkItem {
    ...
    public BenchmarkItem(String name, String domain, String backend, String provider, String description, RunnableBenchmark benchmark) {
        ...
        if (benchmark != null) {
            ...
            this.mode = new SimpleStringProperty(benchmark.getPrecisionMode().name());
        } else {
    ...
    public String getUniqueId() {
        ...
        // Include Provider and Mode to differentiate implementations
        return getName() + " [" + getProvider() + "] (" + getLibrary() + ") [" + getMode() + "]";
    }
}
