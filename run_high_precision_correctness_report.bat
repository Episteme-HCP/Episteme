...
call mvn clean test -pl episteme-benchmarks -am -Dtest=HighPrecisionCorrectnessTest -Dorg.episteme.report.path=docs/HIGH_PRECISION_CORRECTNESS_REPORT.md -DskipTests=false -Dsurefire.failIfNoSpecifiedTests=false
