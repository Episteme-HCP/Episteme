...
mvn clean test -pl episteme-benchmarks -am -Dtest=HighPrecisionComplianceTest -Dorg.episteme.report.path=../docs/HIGH_PRECISION_COMPLIANCE_REPORT.md -DskipTests=false
