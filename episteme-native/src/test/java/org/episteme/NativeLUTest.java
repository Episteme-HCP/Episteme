...
import org.episteme.nativ.mathematics.linearalgebra.backends.NativeFFMBLASRealBackend;
...
public class NativeLUTest {
    ...
    public void testLU() {
        try {
            ...
            try (NativeFFMBLASRealBackend backend = new NativeFFMBLASRealBackend()) {
                int n = 3;
