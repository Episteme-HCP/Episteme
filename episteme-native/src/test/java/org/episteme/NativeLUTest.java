...
public class NativeLUTest {
    ...
    public void testLU() {
        try {
            ...
            org.episteme.core.mathematics.linearalgebra.backends.ColtBackend<Real> colt = new org.episteme.core.mathematics.linearalgebra.backends.ColtBackend<>(Reals.getInstance());
