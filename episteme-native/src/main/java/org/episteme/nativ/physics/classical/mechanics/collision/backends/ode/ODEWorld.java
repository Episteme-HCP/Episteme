...
package org.episteme.nativ.physics.classical.mechanics.collision.backends.ode;
...
public class ODEWorld implements PhysicsWorldBridge {
    ...
    public void stepSimulation(Quantity<Time> timeStep) {
        double dt = timeStep.to(org.episteme.core.measure.units.SI.SECOND).getValue().doubleValue();
