...
public class NativeCUDADenseLinearAlgebraFloatBackend<E extends FieldElement<E>> implements LinearAlgebraProvider<E>, NativeBackend, GPUBackend {
    ...
    public Matrix<E> transpose(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_SGEAM, handle, 1, 0, m, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 1.0f), d_A, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 0.0f), d_A, n, d_C, m));
            
            float[] result = new float[m * n];
            MemorySegment segC = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, m * n);
    ...
    public E dot(Vector<E> a, Vector<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toFloatArray(a)), (long) n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toFloatArray(b)), (long) n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
    ...
    private E dotComplex(Vector<E> a, Vector<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatVec(a)), (long) n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatVec(b)), (long) n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
    ...
    public Matrix<E> conjugateTranspose(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatArray(a)), (long) rows * cols * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_CGEAM, handle, 2, 0, rows, cols, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{1.0f, 0.0f}), d_A, cols, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{0.0f, 0.0f}), d_A, cols, 
                d_C, rows));
            
            float[] result = new float[rows * cols * 2];
            MemorySegment host = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) rows * cols * 2);
    ...
    private Matrix<E> combine(Matrix<E> a, Matrix<E> b, float alpha, float beta) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hB), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_SGEAM, handle, 0, 0, n, m, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, alpha), d_A, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, beta), d_B, n, d_C, n));
    ...
    private Matrix<E> combineComplex(Matrix<E> a, Matrix<E> b, float ar, float ai, float br, float bi) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatArray(a)), (long) m * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatArray(b)), (long) m * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_CGEAM, handle, 0, 0, n, m, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, ar, ai), d_A, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, br, bi), d_B, n, d_C, n));
            
            float[] result = new float[m * n * 2];
            MemorySegment segC = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, m * n * 2);
    ...
    public Vector<E> multiply(Matrix<E> a, Vector<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_X, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hX), (long) n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_SGEMV, handle, 1, n, m, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 1.0f), d_A, n, d_X, 1, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 0.0f), d_Y, 1));
            
            float[] result = new float[m];
            MemorySegment segY = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, m);
    ...
    private Vector<E> multiplyComplex(Matrix<E> a, Vector<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_X, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hX), (long) n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_CGEMV, handle, 1, n, m, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{1.0f, 0.0f}), d_A, n, d_X, 1, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{0.0f, 0.0f}), d_Y, 1));
    ...
    public Matrix<E> multiply(Matrix<E> a, Matrix<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * k * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hB), (long) k * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_SGEMM, handle, 0, 0, n, m, k, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 1.0f), d_B, n, d_A, k, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 0.0f), d_C, n));
    ...
    private Matrix<E> multiplyComplex(Matrix<E> a, Matrix<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hA), (long) m * k * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, hB), (long) k * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            MemorySegment handle = CUDAManager.getCublasHandle();
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_CGEMM, handle, 0, 0, n, m, k, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{1.0f, 0.0f}), d_B, n, d_A, k, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, new float[]{0.0f, 0.0f}), d_C, n));
            float[] result = new float[m * n * 2];
    ...
    public LUResult<E> lu(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aT), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            MemorySegment segA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) m * n);
            ...
            Matrix<E> L = new DenseMatrix<>(flatL, m, Math.min(m,n), (LinearAlgebraProvider<E>) this, ring);
            Matrix<E> U = new DenseMatrix<>(flatU, Math.min(m,n), n, (LinearAlgebraProvider<E>) this, ring);
    ...
    public QRResult<E> qr(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aData), (long) m * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
    ...
    public SVDResult<E> svd(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            MemorySegment segS = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, Math.min(m, n));
            ...
            Vector<E> S = new org.episteme.core.mathematics.linearalgebra.vectors.GenericVector<>(new org.episteme.core.mathematics.linearalgebra.vectors.storage.DenseVectorStorage<>(sVals), (LinearAlgebraProvider<E>) this, ring);
            ...
            Matrix<E> U_mat = new DenseMatrix<>(flatU, m, m, (LinearAlgebraProvider<E>) this, ring);
            ...
            Matrix<E> V_mat = new DenseMatrix<>(flatV, n, n, (LinearAlgebraProvider<E>) this, ring);
    ...
    public Vector<E> solve(Matrix<E> a, Vector<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aData), (long) n * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, bData), (long) n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            MemorySegment segB = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, n);
    ...
    public Matrix<E> solve(Matrix<E> a, Matrix<E> b) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aData), (long) n * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, bData), (long) n * m * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            MemorySegment segB = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * m);
    ...
    public Vector<E> solveTriangular(Matrix<E> a, Vector<E> b, boolean upper, boolean transpose, boolean conjugate, boolean unit) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toFloatArray(a)), (long) n * n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toFloatArray(b)), (long) n * 4, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_STRSM, handle, 1, uplo, trans, diag, 1, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 1.0f), d_A, n, d_B, 1));
            
            float[] result = new float[n];
            MemorySegment hostB = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, n);
    ...
    private Vector<E> solveTriangularComplex(Matrix<E> a, Vector<E> b, boolean upper, boolean transpose, boolean conjugate, boolean unit) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatArray(a)), (long) n * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_B, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, toComplexFloatVec(b)), (long) n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            ...
            checkCublas((int) NativeSafe.invoke(CUDAManager.CUBLAS_CTRSM, handle, 1, uplo, trans, diag, 1, n, 
                NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, 1.0f, 0.0f), d_A, n, d_B, 1));
            
            float[] result = new float[n * 2];
            MemorySegment hostB = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * 2);
    ...
    public CholeskyResult<E> cholesky(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            MemorySegment hostA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * n);
    ...
    public EigenResult<E> eigen(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            MemorySegment hostA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * n);
            MemorySegment hostW = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n);
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, hostA, d_A, (long) n * n * 4, CUDAManager.CUDA_MEMCPY_D_TO_H));
    ...
    private float[] toComplexFloatArray(Matrix<E> m) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                org.episteme.core.mathematics.numbers.complex.Complex c = getComplex(m.get(i, j));
    ...
    private LUResult<E> luComplex(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aT), (long) m * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            MemorySegment handle = CUDAManager.getCusolverHandle();
            MemorySegment pWorkSize = NativeSafe.allocate(arena, ValueLayout.JAVA_INT);
            ...
            MemorySegment segA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) m * n * 2);
    ...
    private QRResult<E> qrComplex(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            MemorySegment d_Info = malloc(4, tracker);
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aData), (long) m * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            MemorySegment handle = CUDAManager.getCusolverHandle();
            MemorySegment pWorkSize = NativeSafe.allocate(arena, ValueLayout.JAVA_INT);
            ...
            return new QRResult<>(new DenseMatrix<>(flatQ, m, m, (LinearAlgebraProvider<E>) this, ring), new DenseMatrix<>(flatR, m, n, (LinearAlgebraProvider<E>) this, ring));
    ...
    private Matrix<E> choleskyComplex(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            MemorySegment d_A = malloc((long) n * n * 8, tracker);
            MemorySegment d_Info = malloc(4, tracker);
            checkCuda((int) NativeSafe.invoke(CUDAManager.CUDA_MEMCPY, d_A, NativeSafe.allocateFrom(NativeSafe, arena, ValueLayout.JAVA_FLOAT, aData), (long) n * n * 8, CUDAManager.CUDA_MEMCPY_H_TO_D));
            MemorySegment handle = CUDAManager.getCusolverHandle();
            MemorySegment pWorkSize = NativeSafe.allocate(arena, ValueLayout.JAVA_INT);
            ...
            MemorySegment segA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * n * 2);
    ...
    private EigenResult<E> eigenComplex(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            float[] wData = new float[n];
            MemorySegment hostA = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n * n * 2);
            MemorySegment hostW = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, (long) n);
    ...
    private SVDResult<E> svdComplex(Matrix<E> a) {
        ...
        try (ResourceTracker tracker = new ResourceTracker()) {
            ...
            Vector<E> S = new org.episteme.core.mathematics.linearalgebra.vectors.GenericVector<>(new org.episteme.core.mathematics.linearalgebra.vectors.storage.DenseVectorStorage<>(sVals), (LinearAlgebraProvider<E>) this, ring);
            return new SVDResult<>(new DenseMatrix<>(flatU, m, m, (LinearAlgebraProvider<E>) this, ring), S, new DenseMatrix<>(flatV, n, n, (LinearAlgebraProvider<E>) this, ring));
