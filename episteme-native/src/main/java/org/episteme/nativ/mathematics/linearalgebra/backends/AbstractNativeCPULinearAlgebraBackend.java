...
public abstract class AbstractNativeCPULinearAlgebraBackend<E> implements LinearAlgebraProvider<E>, NativeBackend, CPUBackend {
    ...
    public boolean isCompatible(Ring<?> ring) {
        ...
        // logger.debug("Backend {} isCompatible({})? {} (this.ring={})", getName(), ring.getClass().getSimpleName(), res, this.ring.getClass().getSimpleName());
        return res;
    }
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            if (complex) {
                if (single) {
                    ...
                    MemorySegment alpha = NativeSafe.allocate(arena, ValueLayout.JAVA_FLOAT, 2);
                    ...
                    MemorySegment alpha = NativeSafe.allocate(arena, ValueLayout.JAVA_DOUBLE, 2);
    ...
    private org.episteme.core.mathematics.linearalgebra.Vector<E> multiplyReal(org.episteme.core.mathematics.linearalgebra.Matrix<org.episteme.core.mathematics.numbers.real.Real> a, org.episteme.core.mathematics.linearalgebra.Vector<org.episteme.core.mathematics.numbers.real.Real> b) {
        if (AVAILABLE && DGEMV_HANDLE != null) {
            ...
            try (Arena arena = Arena.ofConfined()) {
                ...
                MemorySegment rSeg = NativeSafe.allocate(arena, ValueLayout.JAVA_DOUBLE, (long) m);
